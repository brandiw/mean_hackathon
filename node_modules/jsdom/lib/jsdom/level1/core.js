...
core.Node.prototype = {
  ...
  // message
  set nodeName(val) { throw new core.DOMException();},
  get attributes() { return this._attributes;},
  get firstChild() {
    return this._childNodes.length > 0 ? this._childNodes[0] : null;
  },
  set firstChild(val) { throw new core.DOMException();},
  get ownerDocument() { return this._ownerDocument;},
  ...
  set lastChild(val) { throw new core.DOMException();},

  get childNodes() {
    return this._childNodes;
  },
  set childNodes(val) { throw new core.DOMException();},
  ...
  set nextSibling(val) { throw new core.DOMException();},
  ...
  set previousSibling(val) { throw new core.DOMException();},
...
core.ProcessingInstruction.prototype = {
  ...
  set data(val)   { throw new core.DOMException(NO_MODIFICATION_ALLOWED_ERR);},
  get attributes() { return null;}
...
core.Notation.prototype = {
  ...
  set nodeValue(val) { /* intentionally left blank */ },
  get nodeValue() { return this._nodeValue;},
};
